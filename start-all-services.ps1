...
# Start gateway last
Write-Host "Starting API Gateway (Port 8086)..." -ForegroundColor Yellow
...
Write-Host "- API Gateway: http://localhost:8086" -ForegroundColor Cyan
...
Write-Host "`nGateway Swagger UI: http://localhost:8086/swagger-ui.html" -ForegroundColor Magenta

# Optional: Open browser automatically
Start-Process "http://localhost:8086/swagger-ui.html"